...
## Обзор
Реализация алгоритма хеширования ГОСТ Р 34.11-2012 ("Стрибог") представляет собой прямую, точную реализацию стандарта. Код максимально следует описанию алгоритма в спецификации, обеспечивая корректность и прозрачность работы.

*Другие ветки*:
* `debug` — версия с подробным отладочным выводом внутренних преобразований.
